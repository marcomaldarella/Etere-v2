...
export function useScrollManager() {
     ...
     */
    const cleanup = () => {
        if (typeof window === "undefined" || isCleaningRef.current || !ScrollTrigger) return;
        ...
        try {
            ...
            if (ScrollTrigger && typeof ScrollTrigger.clearScrollMemory === 'function') {
            ...
            if (
                ...
                ScrollTrigger.refresh(); // No argument
            }
