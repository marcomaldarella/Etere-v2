...
export default function Carousel() {
    ...
    // Filtra solo i verticali desiderati
    const verticalIds = ["fintech", "healthcare", "logistics"];
    const items = (home?.carousel || []).filter(item => verticalIds.includes(item.id));
    ...
    // Forza il refresh di ScrollTrigger quando cambia la lista delle slide
    useEffect(() => {
    ...
    return (
        <section
            className="carousel-section active"
            ref={containerRef}
