...
const CARDS = [
    {
        ...
        title: "Fintech",
        subtitle: "Bestinver",
        description: "Crafting secure, user-centric financial solutions for portfolio tracking.",
    ...
    },
    {
        ...
        description: "Building intuitive, data-driven health platforms for real-time biosignal tracking.",
    ...
    },
    {
        ...
        title: "Logistics",
        subtitle: "Iveco",
        description: "Optimizing end-to-end operations with a distributed platform for vehicle rentals and telematics.",
    ...
    },
    {
        ...
        title: "Betting",
        subtitle: "SportServe",
        description: "Deploying scalable white-label betting solutions from model to production.",
...
export default function ProjectCards() {
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            ...
            cards.forEach((card, index) => {
                if (index < cards.length - 1) { // Per tutte le card tranne l'ultima
            ...
            cards.forEach((card, index) => {
                if (index > 0) { // Applica questa animazione solo dalla seconda card in poi
            ...
            if (ctaRef.current) {
                ...
                ScrollTrigger.create({
                    ...
                    animation: gsap.to(ctaRef.current, {
                        ...
                        scale: 1,
                        duration: 0.8,
                        ease: "back.out(1.7)" // Stesso easing della CTA della Hero.jsx per coerenza
                    }),
                });
            }
            // ************************************************************
    ...
    return (
        <section ref={scope}>
                                    ...
                                    {card.categories && (
                                        <div className="sticky-project-tags">
                                            {card.categories.map(cat => (
                                                <span key={cat} className="sticky-project-tag">{cat}</span>
                                            ))}
                                        </div>
                                    )}
                                </div>
            ...
            <div className="cta-all-projects-wrapper"> {/* Wrapper per il centraggio e padding */}
